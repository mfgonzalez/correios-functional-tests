...
var SearchCepPage = function() {
    ...
    this.searchByAddressComplete = function(){
        element(by.cssContainingText('option', 'RS')).click();
        element(by.name('Localidade')).sendKeys("Porto Alegre");
        element(by.cssContainingText('option', 'Avenida')).click();
        element(by.name('Logradouro')).sendKeys("Saturnino de Brito");
        element(by.name('Numero')).sendKeys("120");
